...
public:
    ...
    std::vector<ConfigParams_IP> dataIP = {
       {u8"800ИП-1,6-2,5-М1/25-6-2 ", 800, 7120, 20, 1.6, 500},
       {u8"800ИП-2,5-4,0-М1/25-6-2 ", 800, 7120, 20, 2.5, 500},
       {u8"1000ИП-1,6-2,5-М1/25-6-2", 1000, 7205, 20, 1.6, 600},
       {u8"1000ИП-2,5-4,0-М1/25-6-2", 1000, 7205, 20, 2.5, 600},
       {u8"1200ИП-1,6-2,5-М1/25-6-2", 1200, 7335, 20, 1.6, 700},
       {u8"1400ИП-1,6-2,5-М1/25-6-2", 1400, 7690, 20, 1.6, 800},
       {u8"1600ИП-1,6-2,5-М1/25-6-2", 1600, 7735, 20, 1.6, 900},
       {u8"1800ИП-1,6-2,5-М1/25-6-2", 1800, 7950, 20, 1.6, 1000},
       {u8"1800ИП-2,5-4,0-М1/25-6-2", 1800, 7950, 20, 1.6, 1100},
       {u8"2000ИП-1,6-2,5-М1/25-6-2", 2000, 8210, 20, 1.6, 1200},
    };
