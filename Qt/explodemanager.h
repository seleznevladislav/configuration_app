...
public:
    ...
    //  double viscocity;	  // 4 - Коэффициент кинематической взякости (Есть не у всех, если что высчитывается, если 0 ) (Па/с)

    std::vector<data_fluidProperties> fluidsProperties = {
        {u8"Ацетон",                813 , 2.114, 0.174, 0.395, 0.455},
        {u8"Бензин",                900 , 1.800, 0.145, 0, 0.88},
        {u8"Вода дистиллированная", 1000, 4.187, 0.550, 0, 0},
        {u8"Керосин",               850 , 2.430, 0.121, 0, 0},
        {u8"Нефтяное масло 5w40",   890 , 2.430, 0.104, 0, 0},
        {u8"Ртуть чистая",         13600, 0.138, 8.140, 0, 0.1},
        {u8"Спирт метиловый",       810,  2.470, 0.214, 0.817, 0.5},
        {u8"Спирт этиловый",        806,  2.303, 0.188, 1.780, 0.25},
    };
