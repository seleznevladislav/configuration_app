...
public:
    ...
    std::vector<data_fluidProperties> fluidsProperties = {
        ...
        {u8"Бензин",                900 , 1.800, 0.145, 0},
        {u8"Вода дистиллированная", 1000, 4.187, 0.550, 0},
        {u8"Керосин",               850 , 2.430, 0.121, 0},
        {u8"Нефтяное масло",        890 , 2.430, 0.104, 0},
        {u8"Ртуть чистая",         13600, 0.138, 8.140, 0},
        {u8"Спирт метиловый",       810,  2.470, 0.214, 0.817},
        {u8"Спирт этиловый",        806,  2.303, 0.188, 1.780},
    };
