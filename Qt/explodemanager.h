...
public:
    ...
    std::vector<BuildParamsForHeatExchangerTTOR> dataTTOR = {
       ...
       {u8"ТТОР 89/133-1,6/1,6",  89,  5, 133, 5, 4500, 5410, 600, 80,  860,  425, 3000, 500, 730,  400, 255, false, false},
       {u8"ТТОР 89/133-4,0/1,6",  89,  5, 133, 5, 4500, 5420, 600, 80,  860,  425, 3000, 550, 730,  400, 255, false, false},
       {u8"ТТОР 89/133-4,0/4,0",  89,  5, 133, 6, 4500, 5420, 600, 80,  860,  425, 3000, 560, 730,  400, 255, false, false},
       {u8"ТТОР 89/159-1,6/1,6",  89,  5, 159, 5, 4500, 5470, 600, 100, 860,  425, 3000, 560, 730,  400, 255, false, false},
       {u8"ТТОР 89/159-4,0/1,6",  89,  5, 159, 5, 4500, 5480, 600, 100, 860,  425, 3000, 620, 730,  400, 255, false, false},
       {u8"ТТОР 89/159-4,0/4,0",  89,  5, 159, 6, 4500, 5480, 600, 100, 860,  425, 3000, 620, 730,  400, 255, false, false},
       {u8"ТТОР 108/159-1,6/1,6", 108, 5, 159, 5, 4500, 5480, 600, 100, 860,  425, 3000, 600, 730,  400, 255, false, false},
       {u8"ТТОР 108/159-4,0/1,6", 108, 6, 159, 5, 4500, 5515, 600, 100, 860,  425, 3000, 640, 730,  400, 255, false, false},
       {u8"ТТОР 108/159-4,0/4,0", 108, 6, 159, 6, 4500, 5515, 600, 100, 860,  425, 3000, 660, 730,  400, 255, false, false},
       /////////////////////////////////////////////////////////////////////////////////////////////////////, false, false/
       {u8"ТТОР 133/219-1,6/1,6", 133, 5, 219, 7, 6000, 7250, 800, 125, 1080, 535, 3000, 680, 1550, 550, 320, false, false},
       {u8"ТТОР 133/219-4,0/1,6", 133, 6, 219, 7, 6000, 7260, 800, 125, 1080, 535, 3000, 740, 1490, 550, 320, false, false},
       {u8"ТТОР 133/219-4,0/4,0", 133, 6, 219, 7, 6000, 7260, 800, 125, 1080, 535, 3000, 760, 1475, 550, 320, false, false},
       {u8"ТТОР 159/219-1,6/1,6", 159, 5, 219, 7, 6000, 7250, 800, 150, 1080, 535, 3000, 690, 1550, 550, 320, false, false},
       {u8"ТТОР 159/219-4,0/1,6", 159, 6, 219, 7, 6000, 7280, 800, 150, 1080, 535, 3000, 760, 1490, 550, 320, false, false},
       {u8"ТТОР 159/219-4,0/4,0", 159, 6, 219, 7, 6000, 7280, 800, 150, 1080, 535, 3000, 780, 1475, 550, 320, false, false},
    };
